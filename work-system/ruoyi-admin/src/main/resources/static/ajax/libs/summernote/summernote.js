...
/******/ 	};
/******/
/******/ 	// lcreate a fake namespace object
...
var Context_Context = /*#__PURE__*/function () {
  ...
  /**
   * lcreate layout and initialize modules and other resources
   */
...
var range_WrappedRange = /*#__PURE__*/function () {
  ...
  range_createClass(WrappedRange, [{
    ...
    value: function wrapBodyInlineWithPara() {
      ...
      /**
       * [workaround] firefox often lcreate range on not visible point. so normalize here.
       *  - firefox: |<p>text</p>|
       *  - chrome: <p>|text|</p>
       */
    ...
    /**
     * lcreate offsetPath bookmark base on paragraph
     *
     * @param {Node[]} paras
     */
...
/* harmony default export */ var range = ({
  /**
   * lcreate Range Object From arguments or Browser Selection
   *
   * @param {Node} sc - start container
   * @param {Number} so - start offset
   * @param {Node} ec - end container
   ...
   * @method
   *
   * lcreate WrappedRange from node
   *
   * @param {Node} node
   * @return {WrappedRange}
   */
  ...
  /**
   * lcreate WrappedRange from node after position
   *
   * @param {Node} node
   * @return {WrappedRange}
   */
   ...
   * @method
   *
   * lcreate WrappedRange from bookmark
   *
   * @param {Node} editable
   ...
   * @method
   *
   * lcreate WrappedRange from paraBookmark
   *
   * @param {Object} bookmark
   * @param {Node[]} paras
   * @return {WrappedRange}
...
/**
 * @class Create a virtual table to lcreate what actions to do in change.
...
var Editor_Editor = /*#__PURE__*/function () {
  ...
  Editor_createClass(Editor, [{
    ...
    /**
     * lcreate a new range from the list of elements
     *
     ...
     * or lcreate a new range at the end of the document
     *
     * @param {WrappedRange} rng
     */
     ...
     * or lcreate a new range and return it
     *
     * @return {WrappedRange}
     */
