...
<!--细节导航-->
<div id="nav_detail">
    <h5>首页 > 学习用品 > 笔记本电脑 > ${good.itemType} ></h5>
</div>
<!--产品预览-->
<div id="shop_detail">
    <!-- 左侧-->
    <div id="preview" class="lf">
        <div id="mediumDiv">
            <img id="mImg" style="width:430px;height:330px;" src="${basepath}${good.image}"/>
        </div>
        <div id="icon_all">
            <ul id="icon_list">
    ...
    <div class="right_detail lf">
        ...
        <!-- 价格部分-->
        <div class="price">
            <div id="pro_price"><b>学员售价：</b><span>￥${good.price}.00</span></div>
            <div class="promise">
                <b>服务承诺：</b>
                <span>*退货补运费</span>
                <span>*30天无忧退货</span>
        ...
        <p class="accountChose">
            ...
            <!-- 这个隐层的div的目的是：最后加入购物车的时候方便获取数据 -->
            <div style="display:none">
            	<!-- 商品id -->
            	<input type="hidden" id="goodId" value="${good.id}"/>
            	<!-- 商品名称 -->
            	<input type="hidden" id="title" value="${good.title}"/>
            	<!-- 商品图片 -->
            	<input type="hidden" id="image" value="${good.image}"/>
            	<!-- 商品单价 -->
            	<input type="hidden" id="price" value="${good.price}"/>
            </div>
        </p>       
        <!-- 购买部分-->
        <div class="shops" style="width: 600px">
            ...
            <a href="#" class="shop" style="text-align: left;margin-left:7px"  id="cart" onclick="cartClick()"><img src="../images/product_detail/product_detail_img7.png" alt=""/>购物车</a><span>&nbsp;&nbsp;</span>
        ...
        <div class="all">
            ...
            <div id="sale_protection">
                ...
                <div class="sale_content">
                    ...
                    <p class="content">
                        乾坤科技学子商城向您保证所售商品均为正品行货，乾坤科技自营商品开具机打发票或电子发票。
                    </p>
                    ...
                    <p class="content">
                        凭质保证书及乾坤科技商城发票，可享受全国联保服务，与您亲临商场选购的商品享受相同的质量保证。乾坤科技商城还为您提供具有竞争力的商品价格和运费政策，请您放心购买！
            ...
            <div id="packing_list">
                ...
                <p class="content">笔记本 x1 适配器 x1 电源线 x1 电池 x1 说明书（电子版）x1 备注：笔记本电脑的背面只会标注此电脑的系列，例如： XPS 13-9360 ，
                    如果您需要核实此电脑的具体配置型号是否与乾坤科技页面相符，可电话咨询乾坤科技厂商：800-858-2969</p>
            </div>
        </div>
    </div>
    <div class="right rt">
...
<script type="text/javascript">
    ...
    $("#add_cart").click(function(){
		// 获取商品数据
		var num = $("#buy-num").val();// 商品数量
		var id = $("#goodId").val();// 商品id
		var title = $("#title").val();// 商品名称
		var image = $("#image").val();// 商品图片
		var price = $("#price").val();// 商品单价
		var params = {"goodsId":id,"num":num,"goodsTitle":title,"goodsPrice":price,"goodsImage":image};
		var url = "${basepath}/cart/addGoodData.do";
    ...
    /** 点击购物车事件 **/
    function cartClick(){
    	location.href="${basepath}/cart/toCartHTML.do";
    }
