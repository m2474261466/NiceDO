                    ...
                    <div class="check">
                      ...
                      <div class="pudc">
                        <div class="pudc_information"  id="${c.id}">
                            <img src="${basepath}${c.goodsImage}" class="lf" style="width:80px;height:80px;"/>
                            <input type="hidden" name="" value="">
                        <span class="des lf">
                               ${c.goodsTitle}
                              <input type="hidden" name=""   value="${c.id}"  id="cartId">
                        </span>
                            <p class="col lf"><span>颜色：</span><span class="color_des">深空灰  <input type="hidden" name="" value=""></span></p>
                        </div>
                    </div>
                    <div class="pices">
                        <p class="pices_des">乾坤科技专享价</p>
                        <p class="pices_information"><b>￥</b><span>${c.goodsPrice}.00  <input type="hidden" name="" value=""></span></p>
                    </div>
                    <div class="num"><span class="reduc">&nbsp;-&nbsp;</span><input type="text" value="${c.num}" ><span class="add">&nbsp;+&nbsp;</span></div>
                    <div class="totle">
                        <span>￥</span>
                        <span class="totle_information">${c.goodsPrice}*${c.num}</span>
                    </div>
                    <div class="del">
                        <!-- <div>
...
<script>
    ...
    $("#go-buy").click(function(){
        window.location.href="${basepath}/cart/toConfirmHTML.do";
    })
