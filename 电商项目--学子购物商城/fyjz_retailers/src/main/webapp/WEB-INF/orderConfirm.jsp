   		...
   		<div class="product_confirm">
            ...
            <c:forEach items="${map.list}"  var="c">
	            <ul class="item_detail">
	                <li class="p_info">
	                    <b><img src="${basepath}${c.goodsImage}"  style="width:80px;height:80px;"/></b>
	                ...
	                <li class="p_price">
	                    <i>乾坤科技专属价</i>
	                    <br/>
	                    <span class="pro_price">￥<span class="ppp_price">${c.goodsPrice}.00</span></span>
	                </li>
	                <li class="p_count">X<span>${c.num}</span></li>
	                <li class="p_tPrice">￥<span>${c.goodsPrice*c.num}</span></li>
	            </ul>
             </c:forEach>
        </div>
...
<script>
    $(".go_pay").click(function () {
        location.href = "${basepath}/cart/orderHTML.do";
    })
</script>
<script>
