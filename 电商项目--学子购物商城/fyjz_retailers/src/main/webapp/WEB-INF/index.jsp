    ...
    <div class="lf1_bottom">
        ...
        <c:forEach items="${map.goods}" var="g">
        	<div class="item_msg lf">
	            ...
	            <p class="bottom_ys2" style="height:30px;overflow: hidden">${g.title}</p>
    ...
    <div class="lf1_bottom">
        <div class="item_cat lf">
            ...
            <div class="item_cat_all item_color">
            	<c:forEach items="${map2.list2}" var="t" varStatus="z">
            		<p>${t.name}</p>
	                <ul>
	                	<c:forEach items="${map2.list3[z.index]}" var="t2">
        ...
        <c:forEach items="${map2.goods2}" var="g2">
        	<div class="item_msg lf">
	            <img src="${basepath}${g2.image}" alt="图片无法显示" title="${g2.title}"/>
	
	            <p class="bottom_ys2">${g2.title}</p>
	
	            <p class="bottom_ys3 price_ys3">${g2.price}.00</p>
